...
THEME_STYLES = {
    ...
    "ctfa.prompt": Style(color="white", bold=True),
    ...
    "ctfa.prompt.answer": Style(color="orange1", bold=True),
    "ctfa.prompt.message": Style(color="blue"),
    "ctfa.prompt.default": Style(color="bright_black"),
    "ctfa.prompt.choices": Style(color="bright_cyan", dim=True),
    "ctfa.prompt.pointer": Style(color="bright_cyan", bold=True),
    "ctfa.prompt.selected": Style(color="bright_cyan", bold=True),
