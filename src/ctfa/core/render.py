...
def get_template_env() -> Environment:
    ...
    if _env is None:
        _env = Environment(
            loader=PackageLoader("ctfa", "templates"),
            trim_blocks=True,
            lstrip_blocks=True,
...
def render_category_readme(
    ...
    services: list[tuple[ChallengeService, ChallengeConfig]],
) -> str:
...
def render_repo_readme(
    ...
    """Render the README for the entire challenge repository."""
    env = get_template_env()
